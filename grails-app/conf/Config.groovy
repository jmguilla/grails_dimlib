...
grails.app.context = "/dimlib"
grails.serverURL = "http://localhost:9090${grails.app.context}"
environments {
  development {
...
// grails.mail.username & grails.mail.password should be set, they are supposed imported in the present case
grails{
  mail {
    host = "smtp.gmail.com"
    port = 465
